...
export HADOOP_LOG_DIR=/var/hadoop/log/$USER


# Where log files are stored in the secure data environment.
export HADOOP_SECURE_DN_LOG_DIR=/var/hadoop/log/$HADOOP_SECURE_DN_USER
